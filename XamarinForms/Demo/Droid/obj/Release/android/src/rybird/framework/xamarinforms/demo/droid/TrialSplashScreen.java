package rybird.framework.xamarinforms.demo.droid;
...
public class TrialSplashScreen extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen.this, md594fc3880db0ad27db987868599228225.MainActivity.class);

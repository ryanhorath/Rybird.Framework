...
{
    internal class ImageButtonBinding<T> : ViewBinding
    {
        private ImageButton _button;
        private ICommand _targetCommand;
        private Func<T> _parameterCallback;

        public ImageButtonBinding(ImageButton button, ICommand targetCommand) : this(button, targetCommand, null)
        {

        }

        public ImageButtonBinding(ImageButton button, ICommand targetCommand, Func<T> parameterCallback) : base(button)
        {
            _button = button;
